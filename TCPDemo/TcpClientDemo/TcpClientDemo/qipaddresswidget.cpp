...
QIPAddressWidget::QIPAddressWidget(QWidget *parent) : QWidget(parent)
{
    bgColor = "#FFFFFF";
    borderColor = "#A6B5B8";
    borderRadius = 3;
...
bool QIPAddressWidget::eventFilter(QObject *watched, QEvent *event)
{
...
void QIPAddressWidget::textChanged(const QString &text)
{
    int len = text.length();
...
QString QIPAddressWidget::getIP() const
{
    return this->ip;
}

QSize QIPAddressWidget::sizeHint() const
{
    return QSize(250, 20);
}

QSize QIPAddressWidget::minimumSizeHint() const
{
    return QSize(30, 10);
}

void QIPAddressWidget::setIP(const QString &ip)
{
    //先检测IP地址是否合法
...
void QIPAddressWidget::setBgColor(const QString &bgColor)
{
...
void QIPAddressWidget::setBorderColor(const QString &borderColor)
{
...
void QIPAddressWidget::setBorderRadius(int borderRadius)
{
