...
class QDESIGNER_WIDGET_EXPORT QIPAddressWidget : public QWidget
#else
class QIPAddressWidget : public QWidget
#endif
...
public:
    explicit QIPAddressWidget(QWidget *parent = 0);
